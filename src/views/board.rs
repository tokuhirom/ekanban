                ...
                div()
                    ...
                    .child(if self.show_archived {
                        ...
                        div()
                            ...
                            // 小さくは縮まない。0 に落ちるのは自分がその軸に
                            // overflow を持つときだけで、ここが持っているのは
                            // overflow_x_scroll なので縦には効かない。これが無いと
                            // カードが増えたぶんだけここが縦に伸び、カラムも一緒に
                            // 伸びるので、カラム内の overflow_y_scroll が
                            // 「はみ出していない」と判断されて効かなくなる（#43）。
                            .min_h_0()
                            .flex()
                            .gap_4()
                            .p_6()
