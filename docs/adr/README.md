...
| [0026](0026-creating-tags-while-editing-a-card.md) | カードを編集しながらタグを作れるようにする | 2026-09-06 | 有効 |
| [0027](0027-a-single-default-quick-capture-target.md) | クイックキャプチャの既定の入れ先を、先頭のボードに固定する | 2026-09-06 | 有効 |
